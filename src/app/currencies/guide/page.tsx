...
const page: FC = ({ }) => {
    ...
    return <div className="container w-full md:max-w-4xl mx-auto pt-26 dark:text-[#cccbcb] text-slate-900">
        <div className="w-full mt-10 px-4 md:px-6 text-l leading-normal">
            ...
            {/* SUBH EADER 2 */}
            <h1 className="border-l-4 border-green-600 dark:border-green-500 font-medium text-lg italic my-8 pl-8 md:pl-12">Key Characteristics that you should know about </h1>
            ...
            <div className='mt-10 mb-10 py-10'>
                ...
                <div className='mt-10  py-1'>
                    <header className='flex items-baseline'>
                        ...
                        <h5 className=" mb-1 text-2xl font-extrabold leading-none tracking-tight md:text-2xl lg:text-3xl  dark:text-[#E84142] text-[#E84142] border-l-4 border-transparent md:pl-1">Avalanche</h5>
            ...
            <div className="border-b-2 border-green-600 dark:border-green-500"></div>
