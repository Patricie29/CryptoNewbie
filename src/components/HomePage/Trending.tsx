...
const Trending: FC = () => {
    ...
    return <>
        {trendingData.length ? (
            <div className="w-[350px] sm:w-full max-w-md p-8 mt-11 border rounded-lg shadowbg-gray-800 border-gray-700 bg-gray-800 mb-5 md:mb-10 lg:ml-10 mx-auto shadow-xl dark:shadow-md overflow-auto">
